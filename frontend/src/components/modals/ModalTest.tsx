...
export function ModalTest() {
  ...
  const handleModalAction = useCallback(
    (modalType: string, action: string, data?: any) => {
      ...
      if (action === 'open') {
        ...
        if (scenarioId) {
          ...
          setTestMetrics(prev => ({
            ...
            successRate:
              ((prev.completedScenarios + 1) / prev.totalScenarios) * 100,
    ...
    (scenarioId: string) => {
      switch (scenarioId) {
        ...
        case 'info-employee-detail':
          handleModalAction('infoDialog', 'open', {
            type: 'employee',
            data: sampleEmployee,
          });
          break;
    ...
    <Box>
                ...
                {testScenarios.map((scenario, index) => (
                  <Grid item xs={12} sm={6} md={4} key={scenario.id}>
                    <Card
                      ...
                      sx={{
                        cursor: 'pointer',
                        backgroundColor: completedScenarios.has(scenario.id)
                          ? 'success.50'
                          : 'background.paper',
                        borderColor:
              ...
              <Stack spacing={2}>
                <Box>
                  ...
                  <Typography variant='h6'>
                    {testMetrics.completedScenarios} /{' '}
                    {testMetrics.totalScenarios}
                  </Typography>
                </Box>
        ...
        >
          {modals.infoDialog.data?.type === 'employee' ? (
            <Stack spacing={2}>
              ...
              >
                <Avatar
                  src={modals.infoDialog.data.data.photo}
                ...
                <Box>
                  <Typography variant='h6'>
                    {modals.infoDialog.data.data.name}
                  </Typography>
                  <Typography variant='body2' color='text.secondary'>
                    {modals.infoDialog.data.data.position} •{' '}
                    {modals.infoDialog.data.data.department}
                  </Typography>
                </Box>
              </Box>
              ...
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.email}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.phone}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.hireDate}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                  ...
                  <Chip
                    label={modals.infoDialog.data.data.status}
                    size='small'
                    color='success'
                  />
                </Grid>
              ...
              <Box>
                ...
                <Stack direction='row' spacing={1} flexWrap='wrap'>
                  {modals.infoDialog.data.data.assignedAssets.map(
            ...
            <Stack spacing={2}>
              <Grid container spacing={2}>
                <Grid item xs={6}>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.id}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.type}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.manufacturer}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.model}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.serialNumber}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                ...
                <Grid item xs={6}>
                  ...
                  <Typography variant='body1'>
                    {modals.infoDialog.data.data.assignedTo}
                  </Typography>
                </Grid>
                <Grid item xs={6}>
                  <Typography variant='body2' color='text.secondary'>
                  ...
                  <Typography variant='body1'>
                    ₩{modals.infoDialog.data.data.cost.toLocaleString()}
                  </Typography>
                </Grid>
              </Grid>
            </Stack>
      ...
      {modals.alertDialog.open && (
        <AlertDialog
          ...
          title={
            modals.alertDialog.severity === 'success'
              ? '성공'
              : modals.alertDialog.severity === 'error'
                ? '오류'
                : '알림'
          }
