...
export function FormTest() {
    ...
    switch (formType) {
      case 'employee':
        ...
        results.push({
          ...
          message: emailRegex.test(data.email)
            ? '유효한 이메일 주소입니다.'
            : '올바른 이메일 형식이 아닙니다.',
        });
      ...
      case 'hardware':
        ...
        results.push({
          ...
          message:
            data.serialNumber.length >= 5
              ? '유효한 시리얼 번호입니다.'
              : '시리얼 번호는 5글자 이상이어야 합니다.',
        });
      ...
      case 'assignment':
        ...
        results.push({
          ...
          message: dateRegex.test(data.assignDate)
            ? '유효한 날짜입니다.'
  ...
  const handleSubmit = async () => {
    ...
    if (isValid) {
      ...
      setFormData(prev => ({
        ...prev,
        [currentForm]: Object.keys(prev[currentForm]).reduce(
          (acc, key) => ({
            ...acc,
            [key]: '',
          }),
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <FormInput
              ...
              required
              error={
                validationResults.find(r => r.field === 'name')?.isValid ===
                false
              }
              helperText={
                validationResults.find(r => r.field === 'name')?.message
              }
            />
          </Grid>
          <Grid item xs={12} md={6}>
            <FormInput
              ...
              required
              error={
                validationResults.find(r => r.field === 'email')?.isValid ===
                false
              }
              helperText={
                validationResults.find(r => r.field === 'email')?.message
              }
            />
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <FormSelect
              ...
              onChange={value =>
                handleInputChange('employee.department', value)
              }
              options={departmentOptions}
              required
              error={
                validationResults.find(r => r.field === 'department')
                  ?.isValid === false
              }
              helperText={
                validationResults.find(r => r.field === 'department')?.message
              }
            />
          </Grid>
          <Grid item xs={12} md={6}>
            <FormSelect
              ...
              required
              error={
                validationResults.find(r => r.field === 'position')?.isValid ===
                false
              }
              helperText={
                validationResults.find(r => r.field === 'position')?.message
              }
            />
          </Grid>
        </Grid>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <FormInput
              ...
              error={
                validationResults.find(r => r.field === 'phone')?.isValid ===
                false
              }
              helperText={
                validationResults.find(r => r.field === 'phone')?.message
              }
            />
          </Grid>
        </Grid>
    ...
    <Stack spacing={3}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <FormSelect
              ...
              required
              error={
                validationResults.find(r => r.field === 'type')?.isValid ===
                false
              }
              helperText={
                validationResults.find(r => r.field === 'type')?.message
              }
            />
          </Grid>
          <Grid item xs={12} md={6}>
            <FormSelect
              ...
              required
              error={
                validationResults.find(r => r.field === 'status')?.isValid ===
                false
              }
              helperText={
                validationResults.find(r => r.field === 'status')?.message
              }
            />
          </Grid>
        </Grid>
      ...
      <FormGroup title='제품 정보'>
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <FormInput
              ...
              onChange={value =>
                handleInputChange('hardware.manufacturer', value)
              }
              placeholder='Dell, HP, Lenovo 등'
              required
              error={
                validationResults.find(r => r.field === 'manufacturer')
                  ?.isValid === false
              }
              helperText={
                validationResults.find(r => r.field === 'manufacturer')?.message
              }
            />
          </Grid>
          <Grid item xs={12} md={6}>
            <FormInput
              ...
              required
              error={
                validationResults.find(r => r.field === 'model')?.isValid ===
                false
              }
              helperText={
                validationResults.find(r => r.field === 'model')?.message
              }
            />
          </Grid>
        </Grid>
        <FormInput
          ...
          required
          error={
            validationResults.find(r => r.field === 'serialNumber')?.isValid ===
            false
          }
          helperText={
            validationResults.find(r => r.field === 'serialNumber')?.message
          }
        />
      </FormGroup>
    ...
    <Stack spacing={3}>
        ...
        <Grid container spacing={2}>
          <Grid item xs={12} md={6}>
            <FormSelect
              ...
              onChange={value =>
                handleInputChange('assignment.employeeId', value)
              }
              options={[
              ...
              required
              error={
                validationResults.find(r => r.field === 'employeeId')
                  ?.isValid === false
              }
              helperText={
                validationResults.find(r => r.field === 'employeeId')?.message
              }
            />
          </Grid>
          <Grid item xs={12} md={6}>
            <FormSelect
              ...
              required
              error={
                validationResults.find(r => r.field === 'assetId')?.isValid ===
                false
              }
              helperText={
                validationResults.find(r => r.field === 'assetId')?.message
              }
            />
          </Grid>
        </Grid>
      ...
      <FormGroup title='할당 세부사항'>
        <FormInput
          ...
          required
          error={
            validationResults.find(r => r.field === 'assignDate')?.isValid ===
            false
          }
          helperText={
            validationResults.find(r => r.field === 'assignDate')?.message
          }
        />
        <FormTextArea
          label='할당 메모'
