...
export function AssetInfoDisplay({
  ...
  const warrantyStatus = showWarranty
              ...
              {warrantyStatus && (
                ...
                >
                  ...
                  >
                    ...
                    <Typography
                      variant='body2'
                      color={`${warrantyStatus.color}.main`}
                    >
                      {warrantyStatus.text}
                    </Typography>
                  </Box>
    ...
    >
      <Avatar
        sx={{
          ...
          bgcolor: isHardware ? 'info.main' : 'success.main',
          fontSize:
            size === 'large' ? '1.2rem' : size === 'medium' ? '1rem' : '0.8rem',
        }}
      >
        {getAssetIcon(asset.type, assetType)}
      </Avatar>
      <Box sx={{ flexGrow: 1, minWidth: 0 }}>
        ...
        >
          ...
          {warrantyStatus && (
            <Tooltip
              title={`${warrantyStatus.text} - ${warrantyStatus.days}일`}
            >
              <SecurityIcon
                fontSize='small'
                color={warrantyStatus.color as any}
